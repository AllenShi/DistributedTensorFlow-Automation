...
export TF_CONFIG="{\"cluster\": {\"master\": [\"oxr-dev1.fyre.io:2220\"], \"ps\": [\"oxr-dev2.fyre.io:2221\"], \"worker\": [\"oxr-dev2.fyre.io:2222\", \"oxr-dev3.fyre.io:2222\", \"oxr-dev4.fyre.io:2222\", \"oxr-dev5.fyre.io:2222\", \"oxr-dev6.fyre.io:2222\"]}, \"task\": {\"type\": \"worker\", \"index\": 2}}"
