...
export TF_CONFIG="{\"cluster\": {\"master\": [\"oxr-dev1.fyre.ibm.com:2220\"], \"ps\": [\"oxr-dev2.fyre.ibm.com:2221\"], \"worker\": [\"oxr-dev2.fyre.ibm.com:2222\", \"oxr-dev3.fyre.ibm.com:2222\", \"oxr-dev4.fyre.ibm.com:2222\", \"oxr-dev5.fyre.ibm.com:2222\", \"oxr-dev6.fyre.ibm.com:2222\"]}, \"task\": {\"type\": \"ps\", \"index\": 0}}"
