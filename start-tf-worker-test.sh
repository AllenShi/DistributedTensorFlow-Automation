...
export TF_CONFIG="{\"cluster\": {\"master\": [\"monitorsvr1.fyre.ibm.com:2220\"], \"ps\": [\"monitorsvr1.fyre.ibm.com:2221\"], \"worker\": [\"monitorsvr1.fyre.ibm.com:2222\"]}, \"task\": {\"type\": \"worker\", \"index\": 0}}"
